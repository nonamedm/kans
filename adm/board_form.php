...
<section id="anc_bo_function">
    ...
    <div class="tbl_frm01 tbl_wrap">
		...
		<tr>
            <th scope="row"><label for="bo_order">작성전용</label></th>
            <td>
                <?php echo help('체크시 작성 전용 게시판이 됩니다.') ?>
                         <input type="checkbox" name="bo_10" value="1" id="bo_10" <?php echo $board['bo_10']?'checked':''; ?>>
                사용
            </td>
            <td class="td_grpset">
                <input type="checkbox" name="chk_grp_bo_10" value="1" id="chk_grp_bo_10">
                <label for="chk_grp_bo_10">그룹적용</label>
                <input type="checkbox" name="chk_all_bo_10" value="1" id="chk_all_bo_10">
                <label for="chk_all_bo_10">전체적용</label>
            </td>
        </tr>
        ...
        <tr>
            ...
            <td>
                ...
                <select id="bo_sort_field" name="bo_sort_field">
					...
					<option value="CAST(wr_10 AS unsigned) asc, wr_num, wr_reply" <?php echo get_selected($board['bo_sort_field'], "CAST(wr_10 AS unsigned) asc, wr_num, wr_reply"); ?>>wr_10 asc : wr_10 오름차순</option>
                </select>
            </td>
            <td class="td_grpset">
