...
<div class="tbl_head01 tbl_wrap">
    ...
    <tr>
        ...
        <th scope="col">목록 권한</th>
        <th scope="col">작성 권한</th>
        <th scope="col">답글 권한</th>
		<th scope="col">뷰 권한</th>
    ...
    <tr class="<?php echo $bg; ?>">
        ...
        <td class="td_chk">
		  ...
		  <td class="td_chk">
            <label for="bo_skin_<?php echo $i; ?>" class="sound_only">관리자모드스킨스킨</label>
            <?php echo get_skin_select_admin('admin_board', 'bo_skin_admin'.$i, "bo_skin_admin[$i]", $row['bo_skin_admin']); ?>
        </td>
      ...
      <td class="td_chk">
        ...
        <td class="td_chk">
            <input type="text" name="bo_list_level[<?php echo $i ?>]" value="<?php echo $row['bo_list_level'] ?>" id="bo_list_level<?php echo $i; ?>" class="frm_input" size="2">
        </td>
        <td class="td_chk">
            <input type="text" name="bo_write_level[<?php echo $i ?>]" value="<?php echo $row['bo_write_level'] ?>" id="bo_write_level<?php echo $i; ?>" class="frm_input" size="2">
        </td>
        <td class="td_chk">
            <input type="text" name="bo_reply_level[<?php echo $i ?>]" value="<?php echo $row['bo_reply_level'] ?>" id="bo_reply_level<?php echo $i; ?>" class="frm_input" size="2">
        </td>
   <td class="td_chk">
            <input type="text" name="bo_read_level[<?php echo $i ?>]" value="<?php echo $row['bo_read_level'] ?>" id="bo_read_level<?php echo $i; ?>" class="frm_input" size="2">
        </td>
        <td class="td_chk">
