...
<section id="anc_cf_basic">
    ...
    <div class="tbl_frm01 tbl_wrap">
        ...
        <tbody>
		<tr>
            <th scope="row"><label for="cf_title">쇼핑몰 사용 여부<strong class="sound_only">필수</strong></label></th>
            <td><input type="checkbox" name="cf_10" <?if($config['cf_10']) echo "checked"?> value="1">사용</td>
			<th scope="row"><label for="cf_title">회원관리<strong class="sound_only">필수</strong></label></th>
            <td><input type="checkbox" name="cf_9" <?if($config['cf_9']) echo "checked"?> value="1">사용</td>
        </tr>
