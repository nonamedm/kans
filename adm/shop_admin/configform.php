...
<section id ="anc_scf_payment">
    ...
    <div class="tbl_frm01 tbl_wrap">
        ...
        <tr>
            ...
            <td>
                ...
                <select id="de_pg_service" name="de_pg_service">
					...
					<!-- ================= 커스터 마이징 - 결제대행사 추가 [한국원자력아카데미] ================= -->
					<option value="payjoa" <?php echo get_selected($default['de_pg_service'], 'payjoa'); ?>>페이조아</option>
                </select>
            </td>
        </tr>
        <tr class="pg_info_fld kcp_info_fld">
            ...
            <td>
                <?php echo help("KCP 에서 받은 SR 로 시작하는 영대문자, 숫자 혼용 총 5자리를 입력하세요. 예) SR9A3"); ?>
                <!--<span class="sitecode">SR</span> -->
				<input type="text" name="de_kcp_mid" value="<?php echo $default['de_kcp_mid']; ?>" id="de_kcp_mid" class="frm_input" size="4" style="font:bold 15px Verdana;"> 영대문자, 숫자 혼용 5자리
            </td>
        </tr>
        <tr class="pg_info_fld kcp_info_fld">
		...
		<!-- ================= 커스터 마이징 - 결제대행사 추가 [한국원자력아카데미] ================= -->
		<tr class="pg_info_fld payjoa_info_fld">
            <th scope="row">
                <label for="de_payjoa_mid">페이조아 CPID</label><br>
            </th>
            <td>
				<input type="text" name="de_payjoa_mid" value="<?php echo $default['de_payjoa_mid']; ?>" id="de_payjoa_mid" class="frm_input" size="8" style="font:bold 15px Verdana;">
            </td>
        </tr>
