        ...
        <table class="vertical mb20">            
			...
			<tr>
				...
				<td>
					...
					<input type="text" name="mb_2" value="<?php echo $mb['mb_2']; ?>" id="mb_2" class="frm_input" onclick="open_search_member('mb_1', 'mb_2');" readonly size="40" >
				</td>
			...
			<th scope="row"><label for="mb_5">방사선사 면허번호</label></th>
                 <td colspan="3"><input type="text" name="mb_5" value="<?php echo $mb['mb_5'] ?>" id="mb_5" class="frm_input" size="30" /></td>
            </tr>
