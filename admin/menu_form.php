...
//            list += "<label for=\"me_link_"+ms+"\"  class=\"sound_only\">링크<strong class=\"sound_only\"> 필수</strong></label>";
            ...
            list += "<td>";
//            list += "<label for=\"me_link_"+ms+"\"  class=\"sound_only\">링크<strong class=\"sound_only\"> 필수</strong></label>";
            list += "<input type=\"text\" name=\"me_admin_link[]\" value=\""+link+"\" id=\"me_admin_link_"+ms+"\" required class=\"required frm_input full_input\">";
            list += "</td>";
...
//            list += "<button type=\"button\" class=\"btn_add_submenu\">추가</button>";
            <?php } ?>
            list += "<button type=\"button\" class=\"btn_small2 btn_del_menu\">삭제</button>";
            list += "</td>";
            list += "</tr>";
