...
<div id="sct" class="tbl_head02 tbl_wrap">
    ...
    <thead>
    <tr>
        <th scope="col" rowspan=""><?php echo subject_sort_link("ca_id"); ?>분류코드</a></th>
        <th scope="col" id="sct_cate"><?php echo subject_sort_link("ca_name"); ?>분류명</a></th>
        <!--th scope="col" id="sct_amount">상품수</th-->
        <th scope="col" id="sct_sell"><?php echo subject_sort_link("ca_use"); ?>노출여부</a></th>
        <th scope="col" >관리</th>
    </tr>
    </thead>
    <tbody>
    ...
    <tr class="<?php echo $bg; ?>">
        ...
        <td headers="sct_cate" class="sct_name sct_name<?php echo $level; ?>">
            <?php echo $s_level; ?>
            <input type="text" name="ca_name[<?php echo $i; ?>]" value="<?php echo get_text($row['ca_name']); ?>" id="ca_name_<?php echo $i; ?>" required class="frm_input full_input required">
        </td>
        ...
        <td headers="sct_sell" class="td_possible">
            ...
            <label for="ca_use<?php echo $i; ?>">노출</label>
        </td>
        <td class="td_mng" rowspan="">
            <?php echo $s_add; ?>
            <?php echo $s_vie; ?>
            <?php echo $s_upd; ?>
            <?php echo $s_del; ?>
