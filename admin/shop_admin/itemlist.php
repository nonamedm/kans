...
<div class="tbl_head02 tbl_wrap">
    ...
    <tr>
        ...
        <th scope="col" rowspan="2" id="th_camt"><?php echo subject_sort_link('it_cust_price', 'sca='.$sca); ?>재고</a></th>
    ...
    <tr class="<?php echo $bg; ?>">
        ...
        <td headers="th_camt" class="td_numbig td_input">
            <label for="cust_price_<?php echo $i; ?>" class="sound_only">재고</label>
    ...
    <tr class="<?php echo $bg; ?>">
        <td headers="th_pt" class="td_numbig td_input"></td>
        <td headers="th_qty" class="td_numbig td_input">
            <label for="stock_qty_<?php echo $i; ?>" class="sound_only"></label>
        </td>
    </tr>
    <?php
    }
