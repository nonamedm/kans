...
if ($w == '' || $w == 'r') {
	...
	//================= 커스터 마이징 - 게시일자 강제수정 =================
	if (!isset($_POST['wr_datetime']) && !$_POST['wr_datetime']) {
    ...
    $sql = " insert into $write_table
                set wr_num = '$wr_num',
					 ...
					 wr_datetime = '$wr_datetime',  /* wr_datetime = '".G5_TIME_YMDHIS."', */
...
if ($file_upload_msg)
    alert($file_upload_msg, G5_MANAGE_URL.'/board.php?bo_table='.$bo_table.'&amp;wr_id='.$wr_id.'&amp;page='.$page.$qstr);
else
    goto_url(G5_MANAGE_URL.'/board.php?bo_table='.$bo_table.$qstr);
?>
