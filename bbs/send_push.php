<?php
    ...
    $timestamp1 = strtotime("+1 days");
    $yesterDay = date("Y-m-d", $timestamp1);
    
    $sql = 'SELECT mb.mb_10 FROM g5_member mb, g5_write_forum_req fr WHERE mb.mb_id = fr.mb_id AND fr.wr_id = (SELECT wr_id FROM g5_write_forum_info WHERE wr_1 = "'.$yesterDay.'" LIMIT 1)';
    ...
    $dayBfYesterDay = date("Y-m-d", $timestamp2);

    $sql = 'SELECT mb.mb_10 FROM g5_member mb, g5_write_forum_req fr WHERE mb.mb_id = fr.mb_id AND fr.wr_id = (SELECT wr_id FROM g5_write_forum_info WHERE wr_1 = "'.$dayBfYesterDay.'" LIMIT 1)';
