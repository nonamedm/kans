		...
		<table>
			<tr>
				...
				<td>
					<div class="box">
						<ul>
							<li><a href="<?=$s1_2_2_url;?>"><input type="radio" name="s1_2" checked="checked" onclick="document.location.href='<?php echo $s1_2_2_url; ?>';" ><label for="">달력 형</label></a></li>
							<li><a href="<?=$s1_2_2_2_url;?>"><input type="radio" name="s1_2" onclick="document.location.href='<?php echo $s1_2_2_2_url; ?>';"><label for="">리스트 형</label></a></li>
						</ul>
					</div>
				</td>
			</tr>
...
<script type="text/javascript">
	...
	// 로그인으로 보내기
	function goToLogin(){
		document.location.href = "/bbs/login.php?url=<?php echo urlencode($_SERVER['SCRIPT_NAME']."?bo_table=".$bo_table); ?>";
	}
</script>