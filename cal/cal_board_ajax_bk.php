...
//기타추가
					...
					$load_subject .= "<ul>";
					$load_subject .= "<li><h5>교육명</h5><p>교육명교육명</p></li>";
					$load_subject .= "<li><h5>교육시간</h5><p>교육시간교육시간</p></li>";
					$load_subject .= "<li><h5>교육장소</h5><p>교육장소교육장소</p></li>";
					$load_subject .= "<li><h5>신청인원</h5><p>신청인원신청인원</p></li>";
					$load_subject .= "<ul>";
