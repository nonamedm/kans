	...
	<article class="arti1">
		...
		<div class="top_box">
			...
			<div class="rbx">
				...
				<button type="button" onclick="layer_board('엑셀업로드','./cal_excel_upload.php?type=s2_3');">단체 엑셀업로드</button>
			</div>
		</div>
					...
					<td>
						<ol>
							...
							<li>
								...
								<select name="wr_7[]">
									<option value="전문강좌" selected>전문강좌</option>
...
<script type="text/javascript">
	function get_excel(f_arr){
		...
		for(var i = 0; i < f_arr[0].length; i++){
			...
			if(wr_7 == '전문강좌'){ select1 = "selected"; }
			if(wr_7 == '단기강좌'){ select2 = "selected"; }

			html += "<li><label for=\"\">교육구분</label>";
			html += "	<select name=\"wr_7[]\">";
			html += "		<option value=\"전문강좌\" " + select1 + ">전문강좌</option>";
			html += "		<option value=\"단기강좌\" " + select2 + ">단기강좌</option>";
			html += "	</select>";
			html += "</li>";
			...
			html += "<li><label for=\"\">소속</label><input type=\"text\" name=\"wr_11[]\" value=\"" + wr_11 + "\"></li>";
	...
	function add_col(){
		...
		html += "<li><label for=\"\">교육구분</label>";
		html += "	<select name=\"wr_7[]\">";
		html += "		<option value=\"전문강좌\" >전문강좌</option>";
		html += "		<option value=\"단기강좌\" >단기강좌</option>";
		html += "	</select>";
		html += "</li>";
		...
		html += "<li><label for=\"\">소속</label><input type=\"text\" name=\"wr_11[]\"></li>";
