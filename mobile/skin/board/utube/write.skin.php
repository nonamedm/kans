...
<section id="bo_w">
    ...
    <div class="tbl_frm01 tbl_wrap">
        ...
        <tr>
            ...
            <td><?php echo $option ?>
			<?if($board[gr_id]=="s3"){?>
			<input type="checkbox" name="wr_10" value=1 <?=$write[wr_10]?"checked":""?>> 메인노출
			<?}?>
			</td>
        </tr>
        <?php } ?>
        ...
        <tr>
            ...
            <td><input type="text" name="wr_subject" value="<?php echo $subject ?>" id="wr_subject" required class="w50 frm_input required"></td>
        </tr>
<?if($bo_table=="s4_4"){?>
        <tr>
            <th scope="row"><label for="wr_subject">동영상소스<strong class="sound_only">필수</strong></label></th>
            <td><input type="text" name="wr_1" value="<?php echo str_replace("\"","'",$write[wr_1]) ?>" required class="w50 frm_input required"></td>
        </tr>
<?}?>
