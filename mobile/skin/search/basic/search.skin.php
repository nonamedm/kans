...
<form name="fsearch" onsubmit="return fsearch_submit(this);" method="get" class="ct2">
<input type="hidden" name="srows" value="<?php echo $srows ?>"> 
<input type="hidden" name="gr_id" value="s1">
<fieldset id="sch_res_detail" class="">
    <legend>상세검색</legend>
    <div class="sch_wr">
...
<div id="sch_result" class="ct2">
    ...
    for ($idx=$table_index, $k=0; $idx<count($search_table) && $k<$rows; $idx++) {
     ?>
        <h2><a href="./board.php?bo_table=<?php echo $search_table[$idx] ?>&amp;<?php echo $search_query ?>"><?php echo $bo_subject[$idx] ?> 게시판 내 결과</a>
        <div class="sch_more"><a href="./board.php?bo_table=<?php echo $search_table[$idx] ?>&amp;<?php echo $search_query ?>"><i class="fa fa-plus-circle" aria-hidden="true"></i> <strong><?php echo $bo_subject[$idx] ?></strong> 결과 더보기</a></div></h2>
        <ul>
        <?php
