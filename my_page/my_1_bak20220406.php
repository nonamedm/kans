			...
			<div class="table_wrap">
				<table class="table_nomal" style="width: max-content;">
					...
					<tr>
						...
						<td><?php echo $pro_info['wr_content']; ?></td>
...
<!-- 220318 추가된 접수상태 -->
						...
						<td><?php echo number_format($pro_info['wr_8']); ?>원</td>
						...
						<td><?php if($list[$i]['wr_17'] == '결제완료'){ ?><a href="#n" class="bt layer_mypage_bt" onclick="window.open('./my_pop_2.php?wr_id=<?php echo $list[$i]['wr_id']; ?>', 'window2', 'top=100,left=100, width=730,height=1090')">발급받기 <span><img src="<? echo G5_THEME_URL ?>/images/sub/down_white.jpg" alt=""/><?php } ?></td>
						<td><?php if($list[$i]['wr_17'] == '결제완료' && $list[$i]['wr_20'] != '무통장'){ ?><a href="https://agent.payjoa.co.kr/common/PayInfoPrintDirectCard.jsp?DAOUTRX=<?php echo $list[$i]['wr_24']; ?>&STATUS=A" onclick='window.open(this.href, "payJoaTradePrint", "toolbar=yes,scrollbars=yes,resizable=yes,top=100,left=500,width=490,height=800"); return false;'>영수증</a><?php } ?></td>
						<td><?php if($list[$i]['wr_17'] == '결제완료' && $list[$i]['wr_20'] == '무통장'){ ?><a href="<?php echo $down_href; ?>">영수증</a><?php } ?></td>
