...
if($boardfile != ''){
	...
	$query = "update board set writer='".$writer."', passwd='".$passwd."', title='".$title."', content='".$content."', filename='".$boardfile_name."'" ;
	$query = $query." where uid=".$uid;
}else{
	$query = "update board set writer='".$writer."', passwd='".$passwd."', title='".$title."', content='".$content."'";
	$query = $query." where uid=".$uid;
}
