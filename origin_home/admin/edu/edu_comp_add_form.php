...
var str = confirm("수료일을 추가 하시겠습니까?");
if (str)	form.submit();
}
...
<form name='form' action='edu_comp_add.php' method='post'>
<input type=hidden name='id' value='<?=$id?>'>
<input type=hidden name='ju' value='<?=$ju?>'>

<table width=500 border=0 align=center cellpadding=1 cellspacing=1 bgcolor="#6699CC" >
<td width="100" height="25" align="center" bgcolor="#6699CC"><span class="style1">수료일 추가</span></td>
          <td width="393" height="25" bgcolor="#FFFFFF">&nbsp;
		  <select name="comp_year" style="border-width:1;border-color:#6d6d6d; border-style:solid;">
          ...
          <select name="comp_month" style="border-width:1;border-color:#6d6d6d; border-style:solid;">
          ...
          월
          <select name="comp_day" style="border-width:1;border-color:#6d6d6d; border-style:solid;">
          ...
          일
          <input type="button" name="edu_comp_a" value="  추가  " onClick="check();">
	  </td>
</table>
<br>
<br>
