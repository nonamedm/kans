...
if(form.rec_num.value==''){
		alert('계산서번호를 입력하세요!');
		form.rec_num.focus();
		return;
	}

var str = confirm("계산서번호를 추가 하시겠습니까?");
if (str)	form.submit();
}
...
<form name='form' action='rec_num_add.php' method='post'>
<input type=hidden name='id' value='<?=$id?>'>
<input type=hidden name='ju' value='<?=$ju?>'>

<table width=500 border=0 align=center cellpadding=1 cellspacing=1 bgcolor="#6699CC" >
          <td width="100" height="25" rowspan="2" align="center" bgcolor="#6699CC"><span class="style1">계산서번호 추가</span></td>
          <td width="393" height="25" bgcolor="#FFFFFF">&nbsp;
		  <select name="rec_year" style="border-width:1;border-color:#6d6d6d; border-style:solid;">
          ...
          <select name="rec_month" style="border-width:1;border-color:#6d6d6d; border-style:solid;">
          ...
          월
          <select name="rec_day" style="border-width:1;border-color:#6d6d6d; border-style:solid;">
          ...
          <tr>
			...
			<input type=text size='22' name='rec_num' maxlength='16' style="ime-mode:active;border-width:1;border-color:#6d6d6d; border-style:solid;">
			<input type="button" name="pay_day_a" value="  추가  " onClick="check();"></td>
  </table>
<br>
<br>
<div align="center">
