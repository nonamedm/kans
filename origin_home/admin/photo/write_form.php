...
<tr>
	<td bgcolor=#6699CC align=center width='100'>사 진 파 일</td>
	<td>
		<input type='file' size='36' name='photofile' maxlength='50' style="border-width:1;border-color:#6d6d6d; border-style:solid;"></td></tr>
</table>
<br>
