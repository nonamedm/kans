...
function get_skin_select_admin($skin_gubun, $id, $name, $selected='', $event='')
{
    global $config;
...
}else if($config['cf_4'] === $member['mb_id']){
	alert("{$config['cf_4']} 아이디로는 사이트 관리기능에 접근하실수 없습니다", G5_URL);
}
