...
<form name="fmember" id="fmember" action="./member_form_update.php" onsubmit="return fmember_submit(this);" method="post" enctype="multipart/form-data">
    ...
    <input type="hidden" name="page" value="<?php echo $page ?>">
	  ...
	  <input type="hidden" name="mb_nick" value="<?php echo ($mb['mb_nick'])?$mb['mb_nick']:$mb['mb_name']; ?>">
    ...
    <div class="">
        ...
        <table class="vertical mb20">            
			...
			<!-- <tr>
			                <th scope="row"><label for="mb_nick">닉네임<?php echo $sound_only ?></label></th>
			                <td>
			                    <input type="text" name="mb_nick" value="<?php echo $mb['mb_nick'] ?>" id="mb_nick" <?php echo $required_mb_nick ?> class="frm_input <?php echo $required_mb_id_class ?>" size="15" minlength="3" maxlength="20">
			                </td>
			       </tr> -->
