...
<table class="vertical">
	...
	<tr>
		<th scope="row">예약자</th>
		<td class="">
			<input type="text" id="" name="" size="10" maxlength="20">
		</td>
		<th scope="row">휴대폰번호</th>
		<td class="">
			<input type="text" id="" name="" size="10" maxlength="4">
			-
			<input type="text" id="" name="" size="10" maxlength="4">
			-
			<input type="text" id="" name="" size="10" maxlength="4">
	...
	<tr>
		...
		<td class="">
			<input type="text" id="" name="" size="30" maxlength="30">
		</td>
...
<div class="btn_area">
	...
	<div class="btn_area_right">
		<button class="btn_normal" onclick="location.href='./reservation_write.php'">수정완료</button>
