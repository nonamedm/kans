...
<section id="anc_sitfrm_ini">
    ...
    <div class="tbl_frm01 tbl_wrap">
        ...
        <tr>
            <th scope="row"><label for="it_maker">포장단위</label></th>
            <td>
...
<section id="anc_sitfrm_cost">
    ...
    <div class="tbl_frm01 tbl_wrap">
        ...
        <tr>
            ...
            <td>
                회원가 <input type="text" name="it_price" value="<?php echo $it['it_price']; ?>" id="it_price" class="frm_input" size="8"> 원 /
				VIP(안과)<input type="text" name="it_1" value="<?php echo $it['it_1']; ?>" id="it_price" class="frm_input" size="8"> 원 /
				VIP(일반과)<input type="text" name="it_2" value="<?php echo $it['it_2']; ?>" id="it_price" class="frm_input" size="8"> 원 /
				VIP(모든과)<input type="text" name="it_3" value="<?php echo $it['it_3']; ?>" id="it_price" class="frm_input" size="8"> 원 /
				직원<input type="text" name="it_4" value="<?php echo $it['it_4']; ?>" id="it_price" class="frm_input" size="8"> 원
            </td>
            <td class="td_grpset">
...
<section id="anc_sitfrm_img">
    ...
    <div class="tbl_frm01 tbl_wrap">
        ...
        <?php for($i=1; $i<=10; $i++) { ?>
        <tr>
            <th scope="row"><label for="it_img<?php echo $i; ?>"><? if($i == 1){ echo "리스트 메인이미지"; }else{ echo "이미지 ".($i-1);}?></label></th>
...
function fitemformcheck(f)
{
	...
	*/
    ...
    <?// echo get_editor_js('it_mobile_explan'); ?>
