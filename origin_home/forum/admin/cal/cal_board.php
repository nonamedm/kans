...
.cal_board_list {clear: both; margin-top: 20px !important;}
.cal_board_list .load_cal_board tr td{line-height: 1.5; word-break: keep-all; padding: 15px 10px;}
.cal_board_list .load_cal_board tr td .btn_ty2{font-size: 16px; color: #fff; background: #0094dc; line-height: 30px; transition:.3s;}
.cal_board_list .load_cal_board tr td .btn_ty2:hover{background: #000;}
...
<div class="cal_wrap">
	<div class="fillter_cal">
		<table>
						...
						<ul>
							<li>
								<select name="">
									...
									<option value="직장교육">직장교육</option>
									<option value="보수교육">보수교육</option>
									<option value="전문교육">전문교육</option>
							...
							<li>
								<select name="">
									<option value="전체" selected>전체</option>
									<option value="일반신규">일반신규</option>
									<option value="일반정기">일반정기</option>
									<option value="비파괴 신규">비파괴 신규</option>
									<option value="비파괴 정기">비파괴 정기</option>
								</select>
							</li>
						</ul>
					</div>
			...
			<tr>
				<th>지역선택 <br> <input type="checkbox" name=""><label for="">전체</label></th>
				<td>
					<div class="box">
						<ul>
							<li><input type="checkbox" name=""><label for="">서울</label></li>
							<li><input type="checkbox" name=""><label for="">대전</label></li>
							<li><input type="checkbox" name=""><label for="">대구</label></li>
							<li><input type="checkbox" name=""><label for="">광주</label></li>
							<li><input type="checkbox" name=""><label for="">부산</label></li>
							<li><input type="checkbox" name=""><label for="">울산</label></li>
							<li><input type="checkbox" name=""><label for="">경기</label></li>
							<li><input type="checkbox" name=""><label for="">인천</label></li>
							<li><input type="checkbox" name=""><label for="">강원</label></li>
							<li><input type="checkbox" name=""><label for="">충북</label></li>
							<li><input type="checkbox" name=""><label for="">충남</label></li>
							<li><input type="checkbox" name=""><label for="">경북</label></li>
							<li><input type="checkbox" name=""><label for="">경남</label></li>
							<li><input type="checkbox" name=""><label for="">전북</label></li>
							<li><input type="checkbox" name=""><label for="">전남</label></li>
							<li><input type="checkbox" name=""><label for="">제주도</label></li>
						</ul>
					</div>
				</td>
			</tr>
			<tr>
				...
				<td>
					<div class="box">
						<ul>
							<li><input type="checkbox" name=""><label for="">방문</label></li>
							<li><input type="checkbox" name=""><label for="">상설</label></li>
						</ul>
					</div>
				</td>
			</tr>
	...
	<table class="table_nomal cal_board_list ct1">		
		...
		<tbody class="load_cal_board">
			...
			<tr>
				...
				<td>100</td>
				<td>30,000원</td>
				<td><a href="http://www.kans.re.kr/cal/cal_write1.php" class="btn_ty2">신청하기</a></td>
			</tr>
		</tbody>
	</table>
</div>
