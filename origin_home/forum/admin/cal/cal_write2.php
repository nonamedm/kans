	...
	<article class="arti1">
		...
		<div class="top_box">
			...
			<div class="rbx">
				...
				<button type="button" onclick="layer_board('엑셀업로드','./cal_excel_upload.php?type=s2');">단체 엑셀업로드</button>
			</div>
		</div>
...
<script type="text/javascript">
	function get_excel(f_arr){
		...
		for(var i = 0; i < f_arr[0].length; i++){
			...
			if(wr_8 == 'SRI'){ select1 = "selected"; }
			if(wr_8 == 'RI'){ select2 = "selected"; }
			if(wr_8 == '특수'){ select3 = "selected"; }

			html += "<li><label for=\"\">면허</label>";
			html += "	<select name=\"wr_8[]\">";
			html += "		<option value=\"\">선택해주세요.</option>";
			html += "		<option value=\"SRI\" " + select1 + ">SRI</option>";
			html += "		<option value=\"RI\" " + select2 + ">RI</option>";
			html += "		<option value=\"특수\" " + select3 + ">특수</option>";
			html += "	</select>";
			html += "</li>";

			html += "<li><label for=\"\">면허번호</label><input type=\"text\" name=\"wr_9[]\" value=\"" + wr_9 + "\"></li>";
	...
	function add_col(){
		...
		html += "	<select name=\"wr_8[]\">";
		html += "		<option value=\"\">선택해주세요.</option>";
		html += "		<option value=\"SRI\">SRI</option>";
		html += "		<option value=\"RI\">RI</option>";
		html += "		<option value=\"특수\">특수</option>";
		html += "	</select>";
		html += "</li>";

		html += "<li><label for=\"\">면허번호</label><input type=\"text\" name=\"wr_9[]\"></li>";
