...
if ($cmspage)
	define('G5_EDITOR_LIB', G5_EDITOR_PATH."/cms/editor.lib.php");
else if ($config['cf_editor'])
...
if(substr($PHP_SELF,0,4)=="/eng" || strpos($bo_table,"_eng") || $lang == 'eng') $config['cf_theme'].="_eng"; //소스추가
