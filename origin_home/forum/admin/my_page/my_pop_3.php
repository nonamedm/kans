...
<style>
	...
	.my_print{height: 970px; border: 1px solid #0c3354;  box-sizing: border-box; padding: 55px 30px 0; }
	...
	.my_print_bottom ul > li{font-family: 'GyeonggiBatang'; font-size: 17px; line-height: 30px; color: #666; font-weight: 600; display: flex;}
	.my_print_bottom ul > li span{font-family: 'GyeonggiTitleM'; display: block; color: #505050; font-weight: 600; width: 90px;}

	.my_print_bottom .last_ul_box {display: flex; margin-top: 20px;}
	.my_print_bottom .last_ul_box > li{ position: relative; width: 25%;}
	.my_print_bottom .last_ul_box > li:after{position: absolute; content: '/'; right: 20px; top: 0;}
	.my_print_bottom .last_ul_box > li > span{width: auto; padding-right: 10px;}
