...
<tr>
	<td bgcolor=#6699CC align=center width='100'>비밀번호</td>
	<td>
		<input type=text size='22' name='passwd' maxlength='12' style="ime-mode:active;border-width:1;border-color:#6d6d6d; border-style:solid;" value='<?=$row->passwd?>'>&nbsp;최대12자리</td></tr>
<tr>
