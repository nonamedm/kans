...
function viewData(uid){
	...
	var features='left=280,top=250,width=410,height=250,toolbars=no,menubar=no,scrollbars=yes,status=no,resizable=yes';
	...
	<table width="800" border="0" cellpadding="2" cellspacing="2" vspace="2" hspace="2">
		...
		<td align="center" colspan='2'>
			<table border="0" width="100%" cellpadding="3" cellspacing="1">
				...
				<td align="center" width="200">성명</td>
				<td align="center" width="80">주민등록번호</td>
				<td align="center" width="80">email</td>
				<td align="center" width="150">근무처</td>
				<td align="center" width="100">부서</td>
				<td align="center" width="100">신청자</td>
...
?>
				...
				<td  align="center"><?=$row->applier ?></td>
