...
if($ym !=''){
    $sql="select C.* from edu_calendar A, edu_rev B, edu_rev_member C  where A.uid like B.uid and A.uid like C.uid and (A.sdate like '".$ym."%' OR A.edate like '".$ym."%') ";    
    $res=mysql_query($sql);
...
<tr height='30'>
  ...
  <td width='100' height="25" align=center>시작일</td>
...
<?
if($total<1){
	echo"<tr align=center><td height='25' colspan='10' align=center>등록된 접수자가 없습니다.</td></tr>";
}
