...
<section class="s01 s1111 s<?=$cate_num;?>0<?=$page_num;?> s<?=$cate_num;?><?=$page_num;?><?=$spage_num;?><?=$sspage_num;?> clear ct1">
	...
	<div class="cnt_box">
		...
		<article class="arti3 new_page_arti clear">
			<p>※ 온라인 교육 매뉴얼 숙지 후 교육 신청 부탁드립니다. </p>
			<ul class="flex_box">
				<li>
					<a href="http://www.kans.re.kr/board_files/kans-online manual.pdf" target="blank">
				...
				<li>
					<a href="http://www.kanselearning.kr/" >
						<!-- <span class="robo">CONTACT</span> -->
						<h4 style="">온라인 교육장 바로가기</h4>
						<!-- <ol>
							<li class="robo">
								<span>TEL</span>
								02.554.7330
