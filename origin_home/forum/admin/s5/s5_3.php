...
<section class="s05 s<?=$cate_num;?>0<?=$page_num;?> s<?=$cate_num;?><?=$page_num;?><?=$spage_num;?><?=$sspage_num;?> clear ct1">
	<div class="cnt_box">
		...
		<article class="arti2 mt100">
			...
			<div class="bt_box_box">
				<div class="lbx">
					<dl>
						<dt><span>기획운영</span></dt>
						<dd><span>070-4821-3926</span></dd>
					</dl>
				</div>
				<div class="rbx">
					<dl>
						<dt><span>직장교육</span></dt>
						<dd><span>070-4821-3925</span></dd>
					</dl>
					<dl>
						<dt><span>보수교육 <br>회원관리</span></dt>
						<dd><span>02-554-7330</span></dd>
					</dl>
					<dl>
						<dt><span>통신교육 <br>교육비</span></dt>
						<dd><span>02-554-7331</span></dd>
					</dl>
				</div>
			</div>
		</article>
