...
<div id="sod_fin">
        ...
        <section class="sod_fin_list">
            ...
            ?>
            <div class="sod_fin_left">
                <ul id="sod_list_inq" class="sod_list2">
                    <?php
                    ...
                    ?>
                        <div class="li_total" style="padding-left:<?php echo $image_width + 20; ?>px;">
                            <div class="li_opt"><?php echo get_text($opt['ct_option']); ?></div>
                            <div class="li_prqty">
                                <span class="prqty_price li_prqty_sp">판매가 :<span><?php echo number_format($opt_price); ?></span></span> <span class="st_bg"></span>
                                <span class="prqty_qty li_prqty_sp">수량 : <span><?php echo number_format($opt['ct_qty']); ?></span></span> <span class="st_bg"></span>
                                <span class="prqty_sc li_prqty_sp">배송비 :<span> <?php echo $ct_send_cost; ?></span></span>
                            ...
                            <span class="total_price total_span">주문금액 <strong><?php echo number_format($sell_price); ?></strong></span>
                            <span class="total_point total_span">적립포인트 <strong><?php echo number_format($point); ?></strong></span>
                        </div>
                    <?php
                            $tot_point       += $point;
                ...
                <div id="sod_sts_wrap">
                    <span>상품 상태 설명 <i class="fa fa-question-circle" aria-hidden="true"></i></span>
            ...
            <dl id="sod_bsk_tot" class=" sod_fin_right">
    ...
    <section id="sod_fin_cancel">
        ...
        if ($cancel_price == 0) {
            if ($custom_cancel) {
        ?>
        <button type="button" onclick="document.getElementById('sod_fin_cancelfrm').style.display='block';"  id="odcc_op_btn">주문 취소하기</button>
        ...
        ?>
        <p class="cancle_p">주문 취소, 반품, 품절된 내역이 있습니다.</p>
        <?php } ?>
    </section>
