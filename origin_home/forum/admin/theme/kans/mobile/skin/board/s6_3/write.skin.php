		...
		<article class="res_w">
			...
			<div class="tb_outline">
				<div class="div_tb">
                    <div class="div_tb_tr">
						<div class="div_th">
							<label for="wr_classdivision">교육구분</label>
						</div>
						<div class="div_td">
                            <select id="wr_classdivision" name="wr_classdivision" style="width:150px">
					...
					<div class="div_tb_tr">
						<div class="div_th">
							<label for="wr_classname">교육명</label>
						</div>
						<div class="div_td">
							<input type="text" name="wr_classname" value="" id="wr_classname" class="" style="width:200px"  >
						</div>
					</div>
                    ...
                    <div class="div_tb_tr">
						...
						<div class="div_td">
                            <input type="date" id="wr_classdate" name="wr_classdate" value="" class="w25">  ~
                            <input type="date" id="wr_classdate" name="wr_classdate" value="" class="w25">
						</div>
					</div>
                    ...
                    <div class="div_tb_tr">
                        <div class="div_th">
                            <label for="wr_belongname">소속</label>
                        </div>
                        <div class="div_td">
                            <input type="text" name="wr_belongname" value="<?php echo $name ?>" id="wr_belongname" class="" / style="width:200px" required>
                        </div>
                    </div>

                    <div class="div_tb_tr">
                        <div class="div_th">
                            <label for="wr_partname">부서명</label>
                        </div>
                        <div class="div_td">
                            <input type="text" name="wr_partname" value="<?php echo $name ?>" id="wr_partname" class="" / style="width:200px" required>
                        </div>
                    </div>
