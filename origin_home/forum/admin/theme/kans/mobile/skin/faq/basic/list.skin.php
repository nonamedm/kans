...
<div class="faq_list ct1">
	<div id="cs_top" >
		...
		<div class="cs_top_wr cs_top_qa">
			<p>찾으시는 답변이 없으면 <br><strong>1:1문의하기</strong>를 이용해 주세요.</p>
			<a href="<?php echo G5_BBS_URL; ?>/qalist.php" class="btn_blue">1:1 문의하기</a>
		</div>
		<div class="cs_top_wr cs_top_call">
			<h2>전화상담</h2>
			<strong><i class="fa fa-phone" aria-hidden="true"></i> 02-123-1234</strong>
...
<nav id="bo_cate">
    ...
    <ul id="bo_cate_ul">
        ...
        ?>
        <li <?php echo $category_option;?>><a href="<?php echo $category_href;?>?fm_id=<?php echo $v['fm_id']?>"  ><?php echo $category_msg.$v['fm_subject'];?></a></li>
        <?php
        }
        ?>
    </ul>
...
<div id="faq_wrap" class="faq_<?php echo $fm_id; ?>">
    ...
    <section id="faq_con" class="mt30">
        ...
        <ol>
            ...
            ?>
            <li>
                <h3><a href="#none" onclick="return faq_open(this);"><span class="con_q">Q</span> <?php echo conv_content($v['fa_subject'], 1); ?></a></h3>
                <div class="con_inner">
                    <span class="con_a">A</span>
					<?php // echo conv_content($v['fa_content'], 1); ?>
                    <?php echo conv_content($v['fa_content'], 0); ?>
