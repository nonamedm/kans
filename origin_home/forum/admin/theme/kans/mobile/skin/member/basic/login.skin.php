...
<div id="mb_login" class="mbskin">
    <div class="login_wr">
		...
		<form name="flogin" action="<?php echo $login_action_url ?>" onsubmit="return flogin_submit(this);" method="post">
			...
			<div class="login_btn">
				<!-- <a href="<?php echo G5_BBS_URL ?>/password_lost.php" target="_blank" id="login_password_lost" class="btn_pwsch">아이디/비밀번호 찾기</a> -->
				<a href="<?php echo G5_BBS_URL ?>/password_lost.php" target="_blank" id="" class="btn_pwsch">아이디/비밀번호 찾기</a>
	...
	<?php // 쇼핑몰 사용시 여기부터 ?>
		<?php if ($default['de_level_sell'] == 1) { // 상품구입 권한 ?>
			...
			<?php if (preg_match("/orderform.php/", $url)) { ?>
				<section id="mb_login_notmb"  class="login_wr">
					<h2>비회원 구매</h2>
					...
					<div class="btn_confirm">
						<a href="javascript:guest_submit(document.flogin);" class="btn_blue">비회원으로 구매하기</a>
					</div>
					<script>
			...
			<?php } else if (preg_match("/orderinquiry.php$/", $url)) { ?>
				<section id="mb_login_odinfo" class="login_wr">
					<h2>비회원 주문조회</h2>
					...
					<div class="login_odinfo_if">
						<strong class="odinfo_tit">비회원 주문조회 안내</strong>
