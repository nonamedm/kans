			...
			<div class="tbl_frm01 tbl_wrap">
				<table>
					...
					<tr>
						...
						<td>
							<input type="text" name="mb_3" value="<?php echo $member['mb_3']; ?>" maxlength="6" style="border: 1px solid #e6e6e6; background: #f7f7f7;" class="input_bith">  - 
							<input type="text" name="mb_4" value="<?php echo $member['mb_4']; ?>" size="2" maxlength="1" style="border: 1px solid #e6e6e6; background: #f7f7f7;" class="input_bith" >
