	...
	<form name="fregisterform" id="fregisterform" action="<?php echo $register_action_url ?>" onsubmit="return fregisterform_submit(this);" method="post" enctype="multipart/form-data" autocomplete="off">
		...
		<div  id="register_form">
			<div class="tbl_frm01 tbl_wrap">
				<div class="option_ty1">
					<span><input type="radio" name=""><label for="">정회원</label></span>
					<span><input type="radio" name=""><label for="">온라인회원</label></span>
				</div>
				<table>
...
<!-- 변경사항 
1. 이름 > 회사명으로 변경
2. 업종, 담당자, 사무실번호 추가 (사무실번호는 연락처를 복사함. ) -->
			<div class="tbl_frm01 tbl_wrap">
				<table>
					...
					<tr>
						...
						<td>
							...
							<?php } ?>
							<input type="text" id="reg_mb_name" placeholder="회사명" name="mb_name" value="<?php echo get_text($member['mb_name']) ?>" <?php echo $required ?> <?php echo $readonly; ?> class="frm_input <?php echo $required ?> <?php echo $readonly ?>">
							<?php
					...
					<tr>
						<th scope="row"><label for="">업종<strong class="sound_only">필수</strong></label></th>
						<td>
							<input type="text" name="mb_1" value="<?php echo $member['mb_1']; ?>" placeholder="업종" id="" class="frm_input <?php echo $required ?> " minlength="3" maxlength="20" >
						</td>
					</tr>

					<tr>
						<th scope="row"><label for="">담당자<strong class="sound_only">필수</strong></label></th>
						<td>
							<input type="text" name="mb_2" value="<?php echo $member['mb_2']; ?>" placeholder="담당자" id="" class="frm_input <?php echo $required ?> " minlength="3" maxlength="20" >
						</td>
					</tr>
					...
					<?php } ?>
						<tr>
							<th scope="row"><label for="reg_mb_tel">연락처(핸드폰)<?php if ($config['cf_req_tel']) { ?><strong class="sound_only">필수</strong><?php } ?></label></th>
						...
						<tr>
							<th scope="row"><label for="reg_mb_tel">사무실번호<?php if ($config['cf_req_tel']) { ?><strong class="sound_only">필수</strong><?php } ?></label></th>
							<td><input type="text" name="mb_tel" required  placeholder="사무실번호" value="<?php echo get_text($member['mb_tel']) ?>" id="reg_mb_tel" class="required frm_input <?php echo $config['cf_req_tel']?"required":""; ?>" maxlength="20" <?php echo $config['cf_req_tel']?"required":""; ?>></td>
						</tr>
