		...
		<article class="arti1 clear">
			...
			<ul class="fiex_box col3">
				<li>
					...
					<div class="tbx">
						<p>원자력안전법 제106조</p>
						<a href="https://www.law.go.kr/법령/원자력안전법/(20220211,18394,20210810)/제106조" target="blank" class="bg_blue"><img src="<? echo G5_THEME_URL ?>/images/sub/s1111_1.png" /></a>
					</div>
				</li>
				<li>
					...
					<div class="tbx">
						...
						<a href="https://www.law.go.kr/법령/원자력안전법시행령/(20210623,31824,20210622)/제148조
" target="blank" class="bg_sky"><img src="<? echo G5_THEME_URL ?>/images/sub/s1111_1.png" /></a>
				...
				<li>
					...
					<div class="tbx">
						...
						<a href="https://www.law.go.kr/법령/원자력안전법시행규칙/(20211020,01740,20211020)/제138조
" target="blank" class="bg_green"><img src="<? echo G5_THEME_URL ?>/images/sub/s1111_1.png" /></a>
		...
		<h3 class="tit_h3">현재는 코로나로 인하여 온라인 교육을 시행하고 있습니다.</h3>
			<div class="link_box_ty1"><a href="http://kans.re.kr/cal/cal_list.php"target="_blank"class="link_a">집합교육일정 바로가기 <span><img src="<? echo G5_THEME_URL ?>/images/sub/s1111_2.png" /></span></a></div>
	</div>
</section>
