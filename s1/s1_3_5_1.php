<?
	...
	$cate_num = "1";		$page_num = "3";		$spage_num = "5";	$sspage_num = "1";  
...
<section class="s01 s<?=$cate_num;?>0<?=$page_num;?> s<?=$cate_num;?><?=$page_num;?><?=$spage_num;?><?=$sspage_num;?> clear ct1">
	<div class="cnt_box">
		<article class="arti1 clear">
			<h3 class="tit_h3">대구경북디자인센터(기본 교육장과 도보 1분 이내)</h3>
			<div id="daumRoughmapContainer1613450307731" class="root_daum_roughmap root_daum_roughmap_landing"></div>
			<script charset="UTF-8" class="daum_roughmap_loader_script" src="https://ssl.daumcdn.net/dmaps/map_js_init/roughmapLoader.js"></script>
			<script charset="UTF-8">
				new daum.roughmap.Lander({
					"timestamp" : "1613450307731",
					"key" : "24fsz",
				}).render();
			</script>
		</article>
		<article class="arti2 clear">
			<dl class="lbx clear">
				...
				<dd>대구시 동구 동대구로 461</dd>
			</dl>
			<ul class="rbx clear">
				<li><a href="http://kko.to/LIdgSeKD0" target="_blank"><img src="<? echo G5_THEME_URL ?>/images/template/print_1.png" /></a></li>
				<li><a href="#n" onclick="window.open('./s1351_popup.php', 'window', 'top=100,left=100, width=1400,height=590')"><img src="<? echo G5_THEME_URL ?>/images/template/print_2.png" /></a></li>
			</ul>
		</article>
							...
							<dl class="tbx">
								...
								<dd>
									<ol class="" style="letter-spacing: -0.05em;">
										<li>- 동대구역(KTX/SRT) : 도보 17분, 동대구역건너 정류장<br> 814,8140,814 버스(10분)</li>
									</ol>
								</dd>
							</dl>
						</li>
					...
					<ul class="clear">
						<li>
							...
							<dl class="tbx">
								...
								<dd>
									<ol class="clear ">
										<li>- 교육장 인근 정류장 : 대구상공회의소,솔렌슬힐 귀빈예식장</li>
									</ol>
								</dd>
							</dl>
						</li>
						<li>
							...
							<dl class="tbx">
								...
								<dd>
									<ol>
										<li>- 동대구터미널 : 도보 17분, 동대구역건너 정류장<br> 814,8140,814 버스(10분)</li>
									</ol>
								</dd>
							</dl>
						</li>
