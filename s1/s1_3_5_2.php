<?
	...
	$cate_num = "1";		$page_num = "3";		$spage_num = "5";	$sspage_num = "2";  
...
<section class="s01 s<?=$cate_num;?>0<?=$page_num;?> s<?=$cate_num;?><?=$page_num;?><?=$spage_num;?><?=$sspage_num;?> clear ct1">
	<div class="cnt_box">
		<article class="arti1 clear">
			<h3 class="tit_h3">경북대학교</h3>
			<div id="daumRoughmapContainer1613450519411" class="root_daum_roughmap root_daum_roughmap_landing"></div>
			<script charset="UTF-8" class="daum_roughmap_loader_script" src="https://ssl.daumcdn.net/dmaps/map_js_init/roughmapLoader.js"></script>
			<script charset="UTF-8">
				new daum.roughmap.Lander({
					"timestamp" : "1613450519411",
					"key" : "24fs3",
				}).render();
			</script>
		</article>
		<article class="arti2 clear">
			...
			<ul class="rbx clear">
				<li><a href="http://kko.to/sAS8SedYo" target="_blank"><img src="<? echo G5_THEME_URL ?>/images/template/print_1.png" /></a></li>
				<li><a href="#n" onclick="window.open('./s1352_popup.php', 'window', 'top=100,left=100, width=1400,height=590')"><img src="<? echo G5_THEME_URL ?>/images/template/print_2.png" /></a></li>
			</ul>
		</article>
							...
							<dl class="tbx">
								...
								<dd>
									<ol class="" style="letter-spacing: -0.05em;">
										<li>- 동대구역(KTX/SRT) : 동대구역 937버스(약 26분)</li>
									</ol>
								</dd>
							</dl>
						</li>
					...
					<ul class="clear">
						<li>
							...
							<dl class="tbx">
								...
								<dd>
									<ol class="clear ">
										<li>- 교육장 인근 정류장 : 경북대학교 북문앞, 경대아파트 앞,<br> 공고네거리 1</li>
									</ol>
								</dd>
							</dl>
						</li>
						<li>
							...
							<dl class="tbx">
								...
								<dd>
									<ol>
										<li>- 동대구터미널 :동대구역복합환승센터앞 937버스(약24분)</li>
									</ol>
								</dd>
							</dl>
						</li>
