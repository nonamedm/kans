			...
			<div class="wrap s3_col2">
				<div class="lbx">
					...
					<ul>
						...
						<li><span class="robo">07</span>방사선이용은 안전이 우선입니다. <a href="https://youtu.be/B8DWPc1GQpE" target="blank"></a></li>
					</ul>
				</div>
				<div class="rbx">
					<h4>고급</h4>
					<ul>
						...
						<li><span class="robo">07</span>방사성동위원소 안전 이용<a href="https://youtu.be/j9iZk92Uomo" target="blank"></a></li>
						<li><span class="robo">08</span>방사선발생장치 안전 이용<a href="https://youtu.be/3Jz32eBb_u0" target="blank"></a></li>
					</ul>
				</div>
			</div>
		</article>
