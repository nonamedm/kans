...
<section id="bo_w">
	...
	<form name="fwrite" id="fwrite" action="<?php echo $action_url ?>" onsubmit="return fwrite_submit(this);" method="post" enctype="multipart/form-data" autocomplete="off" style="width:<?php echo $width; ?>">
		...
		<?php
			...
			//$is_homepage = false;
			$option = false;
			// if($board[bo_10]){$is_email=true; $is_password=false;}
		?>
		<div class="table_outline">
			<table class="horizen vertical">
				...
				<tbody>
					...
					<tr>
						<th scope="row"><label for="wr_subject">비밀번호<strong class="sound_only">필수</strong></label></th>
						<td>
					...
					<tr>
						<th scope="row"><label for="wr_content">설정일<strong class="sound_only">필수</strong></label></th>
						<td><input type="nubmer" id="wr_content" name="wr_content" value="<?php echo ($content)?$content:"1"; ?>" required class="frm_input required" min="1" max="31"></td>
					</tr>
					<?/* <tr>
    ...
    function fwrite_submit(f)
    {
		...
		f.wr_10.value = f.wr_content.value;
        ...
        if (subject) {
            alert("소속명에 금지단어('"+subject+"')가 포함되어있습니다");
            f.wr_subject.focus();
            return false;
        }
