...
<div id="sod_bsk">
        ...
        <ul class="sod_list">
            ...
            <li class="sod_li">
                ...
                <div class="li_name">
                    ...
                    <div class="li_mod"  style="padding-left:<?php echo $image_width + 25; ?>px;"><?php echo $mod_options; ?></div>
                </div>
                <div class="li_prqty">
                    ...
                    <span class="total_price li_prqty_sp"><span>소계 </span><strong><?php echo number_format($sell_price); ?></strong></span>
                    <span class="total_point li_prqty_sp"><span>적립포인트 </span><?php echo number_format($sum['point']); ?></span>
                </div>
    ...
    ?>
        ...
        <div id="sod_bsk_act" class="btn_confirm">
            <?php if ($i == 0) { ?>
            <a href="<?php echo G5_SHOP_URL; ?>/" class="btn_grd btn_grd1">쇼핑 계속하기</a>
            <?php } else { ?>
            ...
            <a href="<?php echo G5_SHOP_URL; ?>/list.php?ca_id=<?php echo $continue_ca_id; ?>" class="btn_grd">쇼핑 계속하기</a>
            <?php } ?>
        </div>
    </div>
