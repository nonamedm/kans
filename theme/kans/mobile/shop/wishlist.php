...
<div id="sod_ws">
    ...
    <?php
        ...
        for ($i=0; $row = sql_fetch_array($result); $i++) {
            ...
            $image = get_it_image($row['it_id'], 250, 250);
    ?>
        <li>
            ...
            <div class="wish_info">
                ...
                <span class="info_date"><span class="sound_only">보관일 </span><?php echo substr($row['wi_time'], 2, 8); ?></span>
                <div class="wish_chk">
                    <?php
                    // 품절검사
                ...
                <span class="wish_del"><a href="<?php echo G5_SHOP_URL; ?>/wishupdate.php?w=d&amp;wi_id=<?php echo $row['wi_id']; ?>" class="wish_del"><i class="fa fa-trash" aria-hidden="true"></i><span class="sound_only">삭제</span></a></span>
            </div>
        </li>
        <?php
        }
    ...
    <div id="sod_ws_act">
        <button type="submit" class="btn_blue" onclick="return fwishlist_check(document.fwishlist,'direct_buy');">바로구매</button>
        <button type="submit" class="btn03" onclick="return fwishlist_check(document.fwishlist,'');">장바구니</button>
