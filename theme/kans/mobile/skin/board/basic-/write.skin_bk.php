	...
	<form name="fwrite" id="fwrite" action="<?php echo $action_url ?>" onsubmit="return fwrite_submit(this);" method="post" enctype="multipart/form-data" autocomplete="off">
		...
		<article class="res_w">
			...
			<div class="tb_outline">
				<div class="div_tb">
					<?php if ($is_category) {//지원분야 ?>
						<div class="div_tb_tr">
							<div class="div_th">
								<label for="ca_name">지원분야<strong class="sound_only">필수</strong><span class="red">(*)</span></label>
							</div>
							<div class="div_td">
								<select name="ca_name" id="ca_name"  class=" w50" >
						...
						<div class="div_td">
							<ul class="layout_tel">
								...
								<li class="">
									...
									<select id="mb_tel1" name="mb_tel_1">
								...
								<li class=""><input type="text" id="mb_tel2" name="mb_tel_2" class="frm_input" maxlength="4" value="<?=$wr_2_[1]?>"/></li>
								<li class=""><input type="text" id="mb_tel3" name="mb_tel_3" class="frm_input maxlength="4" value="<?=$wr_2_[2]?>" /></li>
							</ul>
						</div>
					</div>
						...
						<div class="div_tb_tr">
							...
							<div class="div_td">
								...
								<?$wr_email_=explode("@",$write[wr_email]);?>
									<li class=""><input type="text" id="wr_email1" name="wr_email1" class="w90" value="<?=$wr_email_[0]?>"> @</li>
...
<script>
	...
	function fwrite_submit(f){
		...
		f.wr_email.value = f.wr_email1.value + "@" + f.wr_email2.value;
			<?}?>
		f.wr_2.value = f.mb_tel_1.value + "-" + f.mb_tel_2.value + "-"+f.mb_tel_3.value;
