			...
			<ul>
				...
				<li>
					...
					<?php if($bo_table == "newsletter"){ ?>
						...
						<a href="" class="view_file_download download_preview" onclick="fileDownload('https://www.kans.re.kr/data/file/newsletter/<?php echo $view['file'][$i]['file'];  ?>','<?php echo $view['file'][$i]['source'] ?>');">　다운로드</a>
					<?php } else {?>
						<a href="/data/file/forum/<?php echo $view['file'][$i]['file'];  ?>" class="view_file_download download_preview">　바로보기</a>
						<a href="" class="view_file_download download_preview" onclick="fileDownload('https://www.kans.re.kr/data/file/forum/<?php echo $view['file'][$i]['file'];  ?>','<?php echo $view['file'][$i]['source'] ?>');">　다운로드</a>
					<?php } ?>
