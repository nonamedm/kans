<?php
	...
	if(!strstr($_SERVER['HTTP_REFERER'], 's1_1_1_2')){ set_session($_SERVER['SERVER_ADDR']."_check_val", false); }

	if(!get_session($_SERVER['SERVER_ADDR']."_check_val")){ // 비회원이 결과 조회를 아직 안했을 경우
		alert("비밀번호 입력 후 진행해주세요.", G5_URL."/s1/s1_1_1_2_new.php");
	}else{ ?>
	<!-- 게시판 목록 시작 -->
	<div id="bo_list<?php if ($is_admin) echo "_admin"; ?>" class="respon_l">
		...
		<h3 class="tit_h3">환영합니다. 2022년도 KANS 온라인 교육장입니다.</h3>
		<ul class="dot_ul" style="margin-bottom:40px;">
			<li>아래의 강좌를 제1강 부터 순서대로 클릭하여 수강하시기 바랍니다.</li>
			<li>먼저 과제물 문제(첨부파일)를 확인하신 후 수강하시기 바랍니다.</li>
			<li>과제물의 답안은 별도 복사용지 등에 강의를 순서대로 수강하면서 자필 작성하시면 됩니다. <br>※ 문제는 안적으셔도 됩니다.</li>
			<li>답안 작성에 시간이 더 필요하시면 화면을 잠시 정지하셔도 됩니다.</li>
			<li>오늘 중 수강 완료가 어렵거나 다른날 추가 수강이 필요하신 경우 관리자(010 3488 3308)에게 연락주세요.</li>
		</ul>
