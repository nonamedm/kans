...
<article id="bo_v" style="width:<?php echo $width; ?>" class="respon_v ct1">
	...
	<section id="bo_v_info">
		...
		<!-- 	<li>작성자 : <strong><?php echo $view['name'] ?><?php if ($is_ip_view) { echo "&nbsp;($ip)"; } ?></strong></li> -->
			<?php if($is_email){?>
			<li>이메일 : <strong><?php echo $view['wr_email']; ?></strong></li>
			<?php } ?>
			<?php if($is_telno){?>
			<li>연락처 : <strong><?php echo $view['wr_2']; ?></strong></li>
			<?php } ?>
	...
	<div id="bo_v_top" class="btm_btns clear">
		...
		<?php } ?>
		<div class="sort_r">
			<?php if ($update_href) { ?><a href="<?php echo $update_href ?>" class="btn_ty">수정</a><?php } ?>
			<?php if ($reply_href) { ?><a href="<?php echo $reply_href ?>" class="btn_ty">답변</a><?php } ?>
			<!-- <?php if ($delete_href) { ?><a href="<?php echo $delete_href ?>" class="btn_ty" onclick="del(this.href); return false;">삭제</a><?php } ?> -->
			
			<a href="<?php echo $list_href ?>" class="btn_ty">목록</a>
		</div>
