				...
				<div class="div_tb_tr">
					...
					<?php if ($is_checkbox) { ?>
						<div class="div_th col_check">
							<label for="chkall" class="hide">현재 페이지 게시물 전체</label>
...
<fieldset id="bo_sch">
	...
	<form name="fsearch" method="get">
		...
		<input type="text" name="stx" value="<?php echo stripslashes($stx) ?>" placeholder="검색어(필수)" required id="stx" class="required frm_input" size="15" maxlength="20">
