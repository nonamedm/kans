...
<article id="bo_v" style="width:<?php echo $width; ?>" class="respon_v ct1">
	...
	<section id="bo_v_info">
		...
		<!-- 	<li>작성자 : <strong><?php echo $view['name'] ?><?php if ($is_ip_view) { echo "&nbsp;($ip)"; } ?></strong></li> -->
			<li>포럼 일정 : <strong><?php echo ($view['wr_1']) ?>일</strong></li>
	...
	<div style="text-align: center; padding: 10px;">
		<div class="wt_btn proposal_btn" id="forum_proposal" onclick="insertForum();">포럼신청</div>
	</div>
...
<script>
	...
	var proposal = confirm('해당 포럼을 신청 하시겠습니까?');
	
	if(proposal == true){
		$.ajax({
			url: "<?php G5_BBS_PATH ?>forum_insert.php",
			type: "POST",
			//dataType: "json",
			data: data,
