...
<article id="bo_v" style="width:<?php echo $width; ?>" class="respon_v ct1">
		...
		<section id="bo_v_file">
			...
			<ul>
				...
				<li>
					...
					<a href="/data/file/community/<?php echo $view['file'][$i]['file'];  ?>" class="view_file_downloa download_preview">　바로보기</a>
					<a href="" class="view_file_download download_preview" onclick="fileDownload('https://www.kans.re.kr/data/file/community/<?php echo $view['file'][$i]['file'];  ?>','<?php echo $view['file'][$i]['source'] ?>');">　다운로드</a>
	...
	<div id="bo_v_top" class="btm_btns clear">
		...
		<div class="sort_r">
			...
			<!--<?php if ($reply_href) { ?><a href="<?php echo $reply_href ?>" class="wt_btn">답변</a><?php } ?>-->
