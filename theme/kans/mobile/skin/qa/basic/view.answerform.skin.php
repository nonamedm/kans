...
<section id="bo_v_ans">
    ...
    <div class="tbl_wrap">
        ...
        <?php } ?>
        <tr>
            <td colspan="2"><label for="qa_subject" class="sound_only">제목</label><input type="text" name="qa_subject" placeholder="제목" value="" id="qa_subject" required class="frm_input required" size="50" maxlength="255"></td>
        </tr>
        <tr>
