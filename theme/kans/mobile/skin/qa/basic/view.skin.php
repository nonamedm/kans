...
<article id="bo_v">
    ...
    <section id="bo_v_info">
        <h2>페이지 정보</h2>
        <span class="bo_name"><span class="sound_only">작성자</span> <i class="fa fa-user" aria-hidden="true"></i><strong><?php echo $view['name'] ?></strong></span>
        <span class="bo_info"><span class="sound_only">작성일</span><i class="fa fa-clock-o" aria-hidden="true"></i><strong><?php echo $view['datetime']; ?></strong></span>
    </section>
    ...
    <section id="bo_v_contact">
        ...
        <ul>
            <?php if($view['email']) { ?>
            <li><span class="sound_only">이메일</span>
            <i class="fa fa-envelope-o" aria-hidden="true"></i> <?php echo $view['email']; ?></li>
            <?php } ?>
            <?php if($view['hp']) { ?>
            <li><span class="sound_only">휴대폰</span>
            <i class="fa fa-phone" aria-hidden="true"></i> <?php echo $view['hp']; ?></li>
            <?php } ?>
        </ul>
    </section>
    <?php } ?>
    ...
    <div id="bo_v_top">
        ...
        <ul class="bo_v_com">
            ...
            <?php if ($write_href) { ?><li><a href="<?php echo $write_href ?>" class="btn_blue">글쓰기</a></li><?php } ?>
        </ul>
        <?php
