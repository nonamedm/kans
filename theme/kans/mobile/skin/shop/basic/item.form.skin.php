<?php
	...
	add_javascript('<script src="'.G5_THEME_JS_URL.'/jquery.bxslider.js"></script>', 10);
?>
	...
	<div id="sit_ov_wrap">
			...
			<div id="sit_pvi_big">
				<?php
					...
					for($i=1; $i<=10; $i++) {
						...
						if($img) {
							// 썸네일
							$thumb = get_it_thumbnail($it['it_img'.$i], 110, 110);
							$thumbnails[] = $thumb;
							$big_img_count++;
				...
				if($total_count > 0) {
					...
					foreach($thumbnails as $val) {
						...
						if ($thumb_count % 5 == 0) $sit_pvi_last = 'class="li_last"';
							...
							echo '<a data-slide-index="'.$slide_idx.'" href="">'.$val.'<span class="sound_only"> '.$thumb_count.'번째 이미지 새창</span></a>';
							echo '</li>';
		...
		<section id="sit_ov">
			...
			<div id="sit_star">
				...
				<span class="sound_only">고객선호도 <span>별<?php echo $score?>개</span></span>
